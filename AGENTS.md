...
- **NEXT:** Phase 5b = CVE/scoring source (VulDB or Kali/Greenbone local DBs — deferred from Phase 3b, feeds cveId/severity/pciSeverity into findings) — lives in the scanner service, not the control-plane portal; needs its own spec + plan.
